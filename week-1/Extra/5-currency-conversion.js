...
function convertToUSD(amountOfCurr) {
	return 1.4 * amountOfCurr;
}
...
function convertToBRL(amountOfBrl) {
	const totalExchange = 5.7 * amountOfBrl;
	const transactions = 5.7 * amountOfBrl * 0.01;
	return totalExchange - transactions;
}
