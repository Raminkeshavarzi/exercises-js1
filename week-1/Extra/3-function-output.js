...
// This code generate random number from 0 to 9
function getNumber() {
	return Math.random() * 10;
}

// Add comments to explain what this function does. You're meant to use Google!
// this code takes two inputs and then by passing them through this fubction concatinate them into one string
function s(w1, w2) {
	return w1.concat(w2);
}
